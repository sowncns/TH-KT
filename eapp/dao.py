...
def load_products(cate_id=None, kw=None, page=1,price=None):
    query = Product.query
...
def add_user(name, username, password, avatar):
    if len(username) < 5:
        raise ValueError("Username phai toi thieu la 5 ky tu")
    if len(password) < 8:
        raise ValueError("Mat khau phai toi thieu la 8 ky tu")
